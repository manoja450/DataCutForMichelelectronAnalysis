...
int main(int argc, char* argv[]) {
    ...
    if (h1 && h2 && h3) {
        ...
        TLegend* legend1 = new TLegend(0.6, 0.6, 0.75, 0.75); // Top-right corner
        ...
        TLegend* legend2 = new TLegend(0.6, 0.6, 0.75, 0.75); // Top-right corner
        legend2->AddEntry(h2, "Good Events", "l");
        legend2->SetBorderSize(0); // Remove box around the legend
        legend2->SetTextSize(0.05); // Increase font size
        legend2->Draw();
        ...
        TLegend* legend3 = new TLegend(0.7, 0.7, 0.75, 0.75); // Top-right corner
        ...
        h1->SetMaximum(10 * maxY); // Increase range for log scale
        ...
        TLegend* legend = new TLegend(0.6, 0.6, 0.75, 0.75); // Just below top-right corner
        ...
        legend->SetTextSize(0.05); // Increase font size
        legend->Draw();
